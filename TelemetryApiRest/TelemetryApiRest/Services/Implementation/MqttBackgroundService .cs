...
{
    public class MqttBackgroundService : BackgroundService,IMqttListener
    {
        ...
        public MqttBackgroundService(IServiceProvider serviceProvider,IEventProcessor eventProcessor, IMapper mapper,
            IOptions<MQTTSettings> mqttConfig, ILogger<MqttBackgroundService> logger)
        {
